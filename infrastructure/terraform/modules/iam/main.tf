...
# ECS Task Role Policy - Custom policy for application permissions
...
resource "aws_iam_role" "codebuild_service_role" {
  name = "${var.project_name}-codebuild-service-role-${var.environment}"
...
resource "aws_iam_role_policy" "codebuild_service_policy" {
  name = "${var.project_name}-codebuild-service-policy-${var.environment}"
