  ...
  optimization: {
    ...
    splitChunks: {
      ...
      cacheGroups: {
        ...
        // Split utilities separately
        utils: {
          test: /[\\/]node_modules[\\/](axios|notistack|date-fns|lodash-es)[\\/]/,
          name: "utils",
          priority: 15,
          chunks: "all",
          enforce: true,
